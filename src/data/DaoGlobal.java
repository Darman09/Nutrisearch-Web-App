...
public class DaoGlobal {
	...
	static public Favoris addProductFavoris(String id, String nom, String grade, String packaging, String paysOrigine,
			String paysVente, String categorie, String ingredientDescription, String quantity) {
		try {
			String data = "http://localhost:8095/rest/favoris/add/?id=" + URLEncoder.encode(id, "UTF-8") + "&nom=" + URLEncoder.encode(nom, "UTF-8") + "&grade="
					+ URLEncoder.encode(grade, "UTF-8") + "&packaging=" + URLEncoder.encode(packaging, "UTF-8")
					+ "&paysOrigine=" + URLEncoder.encode(paysOrigine, "UTF-8") + "&paysVente="
					+ URLEncoder.encode(paysVente, "UTF-8") + "&categorie=" + URLEncoder.encode(categorie, "UTF-8")
					+ "&ingredientDescription=" + URLEncoder.encode(ingredientDescription, "UTF-8") + "&quantity="
